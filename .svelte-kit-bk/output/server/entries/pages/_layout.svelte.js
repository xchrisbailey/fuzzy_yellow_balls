import { s as setContext, g as getContext, a as split_css_unit, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as add_styles, h as compute_rest_props, i as spread, j as escape_attribute_value, k as escape_object, l as subscribe, n as createEventDispatcher, v as validate_component, m as missing_component, o as each } from "../../chunks/ssr.js";
...
const Book_heart = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const iconNode = [
    [
      "path",
      {
  ...
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "book-heart" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
});
const BookHeart = Book_heart;
...
const User$1 = User;
const User_button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { user } = $$props;
  if ($$props.user === void 0 && $$bindings.user && user !== void 0)
    $$bindings.user(user);
  return `<button>${validate_component(Avatar, "Avatar").$$render(
    $$result,
    {
      src: "/tennis_ball.jpg",
    ...
    {},
    {}
  )}</button> <div class="card z-50 w-72 p-4 shadow-xl" data-popup="popup_menu"><h2 class="gradient-heading-blue h3 mb-1">${escape(`${title_case(user.first_name)}  ${title_case(user.last_name)}`)}</h2> <nav class="list-nav gap-4"><ul><li><a href="/profile" class="flex align-middle">${validate_component(User$1, "User").$$render($$result, { class: "mr-2 inline h-4 w-4" }, {}, {})}Profile</a></li> <li><a href="/activity" class="flex align-middle">${validate_component(Pen, "Pen").$$render($$result, { class: "mr-2 inline h-4 w-4" }, {}, {})}Activity</a></li> <li><form method="POST" action="/?/logout" class="flex flex-col"><button class="variant-filled-warning btn" type="submit">${validate_component(LogOut, "LogOut").$$render($$result, { class: "mr-2 h-4 w-4 text-warning-800" }, {}, {})}
						logout</button></form></li></ul></nav></div>`;
});
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(AppBar, "AppBar").$$render(
    ...
    {
      trail: () => {
        return `${!session?.user ? `<a href="/login" class="variant-soft-primary btn">${validate_component(LogIn, "LogIn").$$render($$result, { class: "mr-2 h-4 w-4" }, {}, {})}
				login</a>` : `${validate_component(User_button, "UserButton").$$render($$result, { user: session.user }, {}, {})}`} `;
      },
      lead: () => {
        return `<button>${validate_component(Menu$1, "Menu").$$render($$result, {}, {}, {})}</button>`;
      },
      default: () => {
        return `<div class="gradient-heading-pink h2 font-bold lowercase leading-relaxed drop-shadow-sm" data-svelte-h="svelte-13tperv">Fuzzy Yellow Balls</div>`;
      }
    }
  )}`;
});
const Navigation_links = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let classesActive;
  ...
  $$unsubscribe_page();
  return `<nav class="list-nav p-3 md:p-0"><ul><li><a href="/"${add_attribute("class", classesActive("/"), 0)}><span class="badge bg-primary-300">${validate_component(Home$1, "Home").$$render($$result, { class: "h-4 w-4" }, {}, {})}</span> <span class="flex-auto" data-svelte-h="svelte-hjkn77">home</span></a></li> <li><a href="/strings"${add_attribute("class", classesActive("/strings"), 0)}><span class="badge bg-success-300">${validate_component(Book$1, "Book").$$render($$result, { class: "h-4 w-4" }, {}, {})}</span> <span class="flex-auto" data-svelte-h="svelte-1u62c06">strings</span></a></li> <li><a href="/rackets"${add_attribute("class", classesActive("/rackets"), 0)}><span class="badge bg-secondary-300">${validate_component(BookHeart, "BookHeart").$$render($$result, { class: "h-4 w-4" }, {}, {})}</span> <span class="flex-auto" data-svelte-h="svelte-1twx151">rackets</span></a></li></ul></nav>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Navigation_links, "NavigationLinks").$$render($$result, {}, {}, {})}`;
    }
  })} ${validate_component(Toast, "Toast").$$render($$result, {}, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(AppShell, "AppShell").$$render(
    $$result,
    {
    ...
    {},
    {
      ...
      header: () => {
        return `${validate_component(Header, "Header").$$render($$result, { session: data.session }, {}, {})}`;
      },
      default: () => {
        return `<main class="p-5">${slots.default ? slots.default({}) : ``}</main>`;
      }
    }
  )}`;
});
